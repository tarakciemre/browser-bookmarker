...
class TabManager {
  ...
  constructor() {
    ...
    this.searchBar
      ...
      .addEventListener("click", () => this.renderUrl());

    document
      .querySelector("#star-button")
      .addEventListener("click", () => this.addToBookMark());
    document
      .querySelector("#bookmark-button")
      .addEventListener("click", () => this.openBookMarkTab());
    ...
    this.tabsContainer
      ...
      .forEach((closeButton) => {
        closeButton.addEventListener("click", () =>
          this.closeTab(closeButton.parentElement!)
        );
      });
    ...
    this.addNewTab();
    document
      .getElementById("recommendation-button")
      .addEventListener("click", () => {
        const list = document.getElementById("recommendation-dropdown");
        if (list.style.display === "none") {
          document.getElementById("recommendation-dropdown").style.display =
            "block";
          event.stopPropagation();
          this.appManager.getCurrentRecommendations();
        } else {
          list.style.display = "none";
        }
      });
    document.addEventListener("click", function () {
      document.getElementById("recommendation-dropdown").style.display = "none";
    });
  }
  private addNewTab() {
    ...
    tab.addEventListener("click", () =>
      this.changeUrl(Number(tab.getAttribute("id")))
    );
  ...
  private openBookMarkTab() {
    ...
    this.appManager.addBookmarkTab(
      this.currentTab,
      tab,
  ...
  private renderUrl() {
    const searchBarInput = this.searchBar.querySelector(
      "#search-bar"
    ) as HTMLInputElement;
